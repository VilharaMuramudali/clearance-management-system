...
<style>
    ...
    <p>Username: <?php echo e($user->email); ?></p>
    <p>Password: <?php echo e($password); ?></p>

    
    <a href="<?php echo e(url('/login')); ?>" class="login-button">
        Visit CMS
    </a>
...
</html><?php /**PATH C:\laragon\www\student-clearance-system\resources\views/emails/activation.blade.php ENDPATH**/ ?>